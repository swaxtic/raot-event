	 ...
	 <div class="container">
		 ...
		 <div class="about-info-grids">
		   ...
		   <div class="team">
			  ...
			  <div class="grid_4">
				<div class="team-grid">
						   <img src="images/aa1.jpg" alt="" width='900px' height='370px'>
						   <h4>Rais Darmawan Dwi Yulianto</h4>
						  <p>Putra daerah semarang yang menggemaskan. </p>
					  </div>
			  </div>
			  <div class="grid_4">
				 <div class="team-grid">
						   <img src="images/aa2.jpg" alt="" width='900px' height='370px'>
						   <h4>M.Adip Kolili</h4>
						  <p>Not your typical. </p>
					  </div>
			  </div>
			  <div class="grid_4 span66">
				<div class="team-grid">
						   <img src="images/aa3.jpg" alt="" width='900px' height='370px'>
						   <h4>Oky Wahyu Setiawan</h4>
						  <p>Dark is my favourite condition </p>
					  </div>
			  </div>      
			  <div class="grid_4">				 
					  <div class="team-grid">
						   <img src="images/A11.2016.09794.jpg" alt="" width='900px' height='370px'>
						   <h4>Sandy Dwi Handoko</h4>
						  <p>Mas nya ganteng deh </p>
					  </div>					  
			 </div>
			 <div class="clearfix"></div> 
		  </div>
